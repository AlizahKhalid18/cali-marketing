...
const Hero = () => {
  return (
    ...
    >
      <div className="text-center px-4 py-6 md:py-12 bg-black bg-opacity-50 rounded-lg animate__animated animate__fadeIn animate__delay-1s">
        <h1 className="text-2xl sm:text-4xl md:text-4xl lg:text-6xl font-bold leading-tight animate__animated animate__fadeIn animate__delay-1s">
          Transforming Digital <br /> Ideas into Profitable <br /> Solutions
        </h1>
        <p
          className="mt-2 text-xs sm:text-sm md:text-base lg:text-lg animate__animated animate__fadeIn animate__delay-2s"
          style={{
            color: "#ccaa0d",
          }}
        >
