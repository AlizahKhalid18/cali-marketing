...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="text-center mt-5 px-4 py-6 md:py-12 bg-black bg-opacity-50 rounded-lg animate__animated animate__fadeInUp animate__delay-1s">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight animate__animated animate__fadeInRight animate__delay-1s">
      ...
      <div className="absolute bottom-2 sm:bottom-10 md:bottom-20 right-5 sm:right-10 md:right-20 animate__animated animate__bounceIn animate__delay-3s">
