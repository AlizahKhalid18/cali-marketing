...
const Hero = () => {
  return (
    ...
    >
      {/* Text Content */}
      <div className="text-center lg:mt-5 px-4 py-6 md:py-12 bg-black bg-opacity-50 rounded-lg animate__animated animate__fadeInUp animate__delay-1s">
      ...
      {/* Button */}
      <div className="absolute  sm:bottom-10 md:bottom-20 right-5 sm:right-10 md:right-20 animate__animated animate__bounceIn animate__delay-3s">
